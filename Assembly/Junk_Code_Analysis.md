...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/1.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/6.jpg)

下一步，选中0x401032位置的第一个字节，按下C键把这个位置的字节转换成代码。可以看到CALL EAX指令后面出现了一个字符串”Fintastic!”。

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/7.jpg)

现在代码比刚才清晰多了，你可以看到`loc_40101A`函数的返回值是0x1337

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/8.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/9.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/10.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/11.jpg)

IDA可能会转换比你预期等多的代码，但没关系，因为你知道jz跳转的目标地址是0x40104B，原始的jz指令位于0x401050。

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/12.jpg)

现在选中0x40104B处的一字节，按下C转换成代码，同样操作来转换jz指令的位置，0x401050。做完这些操作后，你应该能看到类似下面这样的代码：

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/13.jpg)

这表示在PUSH指令中间隐藏了另一个跳转指令jmp。

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/14.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/15.jpg)

现在你可以清楚的看到返回值被设置成了0x4096。注意在返回指令retn后面的这几个垃圾字节，是曾经被用来阻止IDA反汇编EAX被赋值这条指令的。

下面截图展示了在没有做任何修改之前，这个函数的执行流程：

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/16.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/17.jpg)

可以看到EAX开始被清空了，然后调用了sub_40107D函数(传入参数0x1000)，最终EAX又增加了0x1000。问题是不知道`sub_40107D`函数的返回值EAX有没有被修改。

来看一下`sub_40107D`函数：

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/18.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/19.jpg)

首先把第一个参数的地址传给了EDX，然后把EDX减去4。还知道现在EDX保存的指针指向哪里么？看一下堆栈的结构：

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/20.jpg)

在EDX减去4后指向了栈上返回地址的位置，然后，在第三行，给返回地址增加了0x2B。这表示当前函数sub_40107D的返回地址被修改了，它将跳转到代码的其他地方。

为了检查它会跳转到哪里，返回来看一下sub_401065:

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/21.jpg)

原始的返回地址是0x401074。但是你知道它被增加了0x2B。所以`sub_40107D`将会返回到0x40109F(0x401074+0x2B)。切换到下一个视图找到这个返回地址的位置。

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/22.jpg)

一点也不意外返回地址的位置出现了花指令，按U转换成数据，然后在0x40109F的位置按C再转成代码：

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/23.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/24.jpg)

中间代码忽略

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/25.jpg)

如果你进入到这个函数看反汇编代码，你将看到很多的反汇编代码在用各种指令来操作EAX寄存器。尽管如此，如果你仔细看就会发现，有一些组合指令都在执行一些无意义的操作。

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/26.jpg)

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/27.jpg)

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/28.jpg)

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/29.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/30.jpg)

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/31.jpg)

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/32.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/33.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/34.jpg)

在sub_40116D这个函数中，栈的结构应该是这样的（安装SHE之后）：

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/35.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/36.jpg)
...
![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/40.jpg)

现在切换视图到0x4011A1的位置：

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/38.jpg)

重复我们之前的套路，把0x4011A1位置的数据转换成代码：

![](https://github.com/yxshyj/yxshyj.github.io/tree/master/img/pic/junk_code/39.jpg)
